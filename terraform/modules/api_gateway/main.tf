...
resource "aws_apigatewayv2_integration" "list_integration" {
  ...
  integration_uri        = "arn:aws:apigateway:${var.region}:lambda:path/2015-03-31/functions/arn:aws:lambda:${var.region}:${var.account_id}:function:get_items/invocations"
